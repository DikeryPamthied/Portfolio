...
<script setup lang="ts">
  ...
  const people = [
    ...
    {
      quote:
        'Working with Dikery on the Axon website has been an exceptional experience. His invaluable support and dedication were crucial in bringing this project to life. Thank you, Diker!',
      author: 'Esmail Atta',
