      ...
      <div class="relative flex w-full flex-col items-center">
        ...
        <div class="lg:column-gap spacing-t grid w-full grid-cols-12">
          ...
          >
            ...
            <p class="sr-only">
              A front-end developer, video editor, and graphic designer, crafting visually stunning and interactive experiences.
            </p>
            <p
              v-html="whoAmI"
              id="whoAmI"
          ...
          >
            ...
            <img
              id="profile-img"
              :src="profile"
              alt="Dikery - Front-end Developer & Designer"
...
const handleClick = () => {
  window.open('https://mail.google.com/mail/?view=cm&fs=1&to=dikery377@gmail.com&su=Inquiry&body=Hello%20Dikery,', '_blank');
};
</script>
